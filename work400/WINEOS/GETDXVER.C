...
//        OutputDebugString("Couldn't CreateSurface\r\n");
     ...
     */
    if (FAILED(IDirectDraw_QueryInterface(pSurf,&IID_IDirectDrawSurface3, (LPVOID *) & pSurf3)))
    {
        IDirectDraw_Release(pDDraw);
        FreeLibrary(DDHinst);
    ...
    *pdwDXVersion = 0x500;
     ...
     */
    if (FAILED(IDirectDraw_QueryInterface(pSurf,&IID_IDirectDrawSurface4, (LPVOID *) & pSurf4)))
    {
        IDirectDraw_Release(pDDraw);
        FreeLibrary(DDHinst);
